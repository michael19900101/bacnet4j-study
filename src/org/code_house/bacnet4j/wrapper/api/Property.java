...
/**
 * Represents an BACnet device property (object).
 *
 * @deprecated Please migrate use of this type to {@link BacNetObject}.
 */
@Deprecated
public class Property {
    ...
    public BacNetObject toBacNetObject() {
        return new BacNetObject(device, id, type, name, description, units);
    }
